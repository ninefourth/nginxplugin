...
#include "../../ngx_http_waf_module/inc/ngx_http_waf_module_ip_trie.h"
#include "../../ngx_http_waf_module/inc/ngx_http_waf_module_lru_cache.h"
#include "../../ngx_http_waf_module/inc/ngx_http_waf_module_macro.h"
#include "../../ngx_http_waf_module/inc/ngx_http_waf_module_type.h"
#include "../../ngx_http_waf_module/inc/ngx_http_waf_module_under_attack.h"
#include "../../ngx_http_waf_module/inc/ngx_http_waf_module_util.h"
#include "../../ngx_http_waf_module/inc/ngx_http_waf_module_vm.h"
...
//modified 放置waf的名称对应的配置信息
struct {
	ngx_array_t          *name; //ngx_str_t
	ngx_array_t         *waf_cf; //ngx_http_waf_loc_conf_t*
	ngx_uint_t			 count;
} waf_env_conf;
